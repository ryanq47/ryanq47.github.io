...
# Current Projects:
![Logec-Attack (Name not final)](#): A GUI based, offensive based swiss army knife of tools (Mouthful, I know). Rational for existance: I wanted to create a tool, mainly to challenge myself, and figure out how other tools are created. The motto for the project is, "It's not the fastest, or the best, but it's damn convenient". 
